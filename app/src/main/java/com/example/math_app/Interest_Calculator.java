...
public class Interest_Calculator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputSumma.addTextChangedListener(new Interest_Calculator.GenericTextWatcher(inputSumma));
        inputPeriood.addTextChangedListener(new Interest_Calculator.GenericTextWatcher(inputPeriood));
        inputIntress.addTextChangedListener(new Interest_Calculator.GenericTextWatcher(inputIntress));
